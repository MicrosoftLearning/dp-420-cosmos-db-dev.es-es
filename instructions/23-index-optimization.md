...
1. Busque la variable de **cadena** denominada **punto de conexión**. Establezca su valor en el **punto de conexión** de la cuenta de Azure Cosmos DB que creó anteriormente.
...
1. Busque la variable de **cadena** denominada **clave**. Establezca su valor en la **clave** de la cuenta de Azure Cosmos DB que creó anteriormente.
